    ...
    b.DEFAULTS = { toggle: !0 }, b.prototype.dimension = function() { var a = this.$element.hasClass("width"); return a ? "width" : "height" }, b.prototype.show = function() {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                this.$element.removeClass("collapse").addClass("collapsing")[e](0).prev(".bb").addClass("upimg"), this.transitioning = 1;
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                this.$element[c](this.$element[c]())[0].offsetHeight, this.$element.addClass("collapsing").removeClass("collapse").removeClass("in").prev(".bb").removeClass("upimg"), this.transitioning = 1;
